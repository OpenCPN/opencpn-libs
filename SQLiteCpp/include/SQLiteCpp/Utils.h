...
#ifdef _MSC_VER
#if _MSC_VER < 1600
/// A macro to enable the use of the nullptr keyword (NULL on older MSVC
/// compilers, as they do not accept "nullptr_t")
#ifndef nullptr
#define nullptr NULL
#endif                                                  // nullptr
#endif                                                  // _MSC_VER < 1600
    ...
    !defined(__GXX_EXPERIMENTAL_CXX0X__)  // before C++11 on GCC4.7 and Visual
                                          // Studio 2010
#ifndef HAVE_NULLPTR
...
public:
  template <typename T>
  inline operator T*()
      const {  ///< convertible to any type of null non-member pointer...
    return 0;
  }

  template <typename C, typename T>
  inline operator T C::*()
      const {  ///< convertible to any type of null member pointer...
    return 0;
  }
