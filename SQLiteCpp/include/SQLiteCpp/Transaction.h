 ...
 * @file    Transaction.h
 * @ingroup SQLiteCpp
 * @brief   A Transaction is way to group multiple SQL statements into an atomic
 * secured operation.
 *
 ...
 * secured operation; either it succeeds, with all the changes committed to the
 ...
 * begins in the constructor and is rollbacked in the destructor, so that there
