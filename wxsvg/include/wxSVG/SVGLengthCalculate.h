...
#define WX_SVG_LENGTH_CALC_WIDTH(l, viewportElement)                       \
  ...
  l.ToViewportWidth(                                                       \
      ((wxSVGSVGElement*)viewportElement)->GetWidth().GetAnimVal())
...
#define WX_SVG_ANIM_LENGTH_LIST_CALC_WIDTH(l, viewportElement)      \
  WX_SVG_LENGTH_LIST_CALC_WIDTH(((wxSVGLengthList&)l.GetBaseVal()), \
                                viewportElement)
#define WX_SVG_ANIM_LENGTH_LIST_CALC_HEIGHT(l, viewportElement)      \
  WX_SVG_LENGTH_LIST_CALC_HEIGHT(((wxSVGLengthList&)l.GetBaseVal()), \
                                 viewportElement)
#define WX_SVG_ANIM_LENGTH_LIST_CALC_SIZE(l, viewportElement)      \
  WX_SVG_LENGTH_LIST_CALC_SIZE(((wxSVGLengthList&)l.GetBaseVal()), \
                               viewportElement)
