...
public:
  ...
  inline const wxSVGAnimatedNumberList& GetKernelMatrix() const {
    return m_kernelMatrix;
  }
  inline void SetKernelMatrix(const wxSVGAnimatedNumberList& n) {
    m_kernelMatrix = n;
  }
  inline void SetKernelMatrix(const wxSVGNumberList& n) {
    m_kernelMatrix.SetBaseVal(n);
  }
  ...
  inline const wxSVGAnimatedEnumeration& GetEdgeMode() const {
    return m_edgeMode;
  }
  ...
  inline const wxSVGAnimatedLength& GetKernelUnitLengthX() const {
    WX_SVG_ANIM_LENGTH_CALC_WIDTH(m_kernelUnitLengthX, GetViewportElement());
    return m_kernelUnitLengthX;
  }
  inline void SetKernelUnitLengthX(const wxSVGAnimatedLength& n) {
    m_kernelUnitLengthX = n;
  }
  inline void SetKernelUnitLengthX(const wxSVGLength& n) {
    m_kernelUnitLengthX.SetBaseVal(n);
  }

  inline const wxSVGAnimatedLength& GetKernelUnitLengthY() const {
    WX_SVG_ANIM_LENGTH_CALC_HEIGHT(m_kernelUnitLengthY, GetViewportElement());
    return m_kernelUnitLengthY;
  }
  inline void SetKernelUnitLengthY(const wxSVGAnimatedLength& n) {
    m_kernelUnitLengthY = n;
  }
  inline void SetKernelUnitLengthY(const wxSVGLength& n) {
    m_kernelUnitLengthY.SetBaseVal(n);
  }

  inline const wxSVGAnimatedBoolean& GetPreserveAlpha() const {
    return m_preserveAlpha;
  }
  inline void SetPreserveAlpha(const wxSVGAnimatedBoolean& n) {
    m_preserveAlpha = n;
  }
...
public:
  ...
  wxSvgXmlNode* CloneNode(bool deep = true) {
    return new wxSVGFEConvolveMatrixElement(*this);
  }
