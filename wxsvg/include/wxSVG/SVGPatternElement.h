...
class wxSVGPatternElement : public wxSVGElement,
...
public:
  inline const wxSVGAnimatedEnumeration& GetPatternUnits() const {
    return m_patternUnits;
  }
  inline void SetPatternUnits(const wxSVGAnimatedEnumeration& n) {
    m_patternUnits = n;
  }
  inline void SetPatternUnits(unsigned char n) { m_patternUnits.SetBaseVal(n); }

  inline const wxSVGAnimatedEnumeration& GetPatternContentUnits() const {
    return m_patternContentUnits;
  }
  inline void SetPatternContentUnits(const wxSVGAnimatedEnumeration& n) {
    m_patternContentUnits = n;
  }
  inline void SetPatternContentUnits(unsigned char n) {
    m_patternContentUnits.SetBaseVal(n);
  }

  inline const wxSVGAnimatedTransformList& GetPatternTransform() const {
    return m_patternTransform;
  }
  inline void SetPatternTransform(const wxSVGAnimatedTransformList& n) {
    m_patternTransform = n;
  }
  inline void SetPatternTransform(const wxSVGTransformList& n) {
    m_patternTransform.SetBaseVal(n);
  }
...
public:
  ...
  wxSvgXmlNode* CloneNode(bool deep = true) {
    return new wxSVGPatternElement(*this);
  }
