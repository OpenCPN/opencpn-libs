...
class wxSVGViewSpec : public wxSVGZoomAndPan, public wxSVGFitToViewBox {
protected:
...
public:
  ...
  inline const wxString& GetPreserveAspectRatioString() const {
    return m_preserveAspectRatioString;
  }
  inline void SetPreserveAspectRatioString(const wxString& n) {
    m_preserveAspectRatioString = n;
  }

  inline const wxString& GetTransformString() const {
    return m_transformString;
  }
  inline void SetTransformString(const wxString& n) { m_transformString = n; }

  inline const wxString& GetViewTargetString() const {
