...
public:
  ...
  wxSVGAnimatedLength(const wxSVGLength& value)
      : m_baseVal(value), m_animVal(NULL) {}
  wxSVGAnimatedLength(const wxSVGAnimatedLength& value)
  ...
  inline wxSVGAnimatedLength& operator=(const wxSVGAnimatedLength& value) {
    ...
    m_animVal =
        value.m_animVal != NULL ? new wxSVGLength(*value.m_animVal) : NULL;
    return *this;
  }

  inline wxSVGLength& GetBaseVal() { return m_baseVal; }
  inline const wxSVGLength& GetBaseVal() const { return m_baseVal; }
  inline void SetBaseVal(const wxSVGLength& value) {
    m_baseVal = value;
    ResetAnimVal();
  }

  inline wxSVGLength& GetAnimVal() {
    if (!m_animVal) m_animVal = new wxSVGLength(m_baseVal);
    return *m_animVal;
  }
