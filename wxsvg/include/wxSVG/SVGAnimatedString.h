...
public:
  ...
  wxSVGAnimatedString(const wxString& value)
      : m_baseVal(value), m_animVal(NULL) {}
  wxSVGAnimatedString(const wxSVGAnimatedString& value)
  ...
  inline wxSVGAnimatedString& operator=(const wxSVGAnimatedString& value) {
    ...
    m_animVal = value.m_animVal != NULL ? new wxString(*value.m_animVal) : NULL;
    return *this;
  }

  inline wxString& GetBaseVal() { return m_baseVal; }
  inline const wxString& GetBaseVal() const { return m_baseVal; }
  inline void SetBaseVal(const wxString& value) {
    m_baseVal = value;
    ResetAnimVal();
  }

  inline wxString& GetAnimVal() {
    if (!m_animVal) m_animVal = new wxString(m_baseVal);
    return *m_animVal;
  }
