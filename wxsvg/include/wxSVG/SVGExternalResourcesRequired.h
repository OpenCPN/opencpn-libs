...
public:
  inline const wxSVGAnimatedBoolean& GetExternalResourcesRequired() const {
    return m_externalResourcesRequired;
  }
  inline void SetExternalResourcesRequired(const wxSVGAnimatedBoolean& n) {
    m_externalResourcesRequired = n;
  }
  inline void SetExternalResourcesRequired(bool n) {
    m_externalResourcesRequired.SetBaseVal(n);
  }
