...
WX_DECLARE_HASH_MAP(wxCSS_PROPERTY, wxCSSValue*, wxIntegerHash, wxIntegerEqual,
                    wxHashMapCSSValue);
...
public:
  ...
  inline const wxCSSValue& GetPropertyCSSValue(
  ...
  void SetProperty(const wxString& propertyName,
...
public:
  inline wxString GetPropertyValue(wxCSS_PROPERTY propertyId) const {
    const_iterator it = find(propertyId);
    if (it != end()) return it->second->GetCSSText();
    return wxT("");
  }

  inline const wxCSSValue& GetPropertyCSSValue(
      wxCSS_PROPERTY propertyId) const {
    const_iterator it = find(propertyId);
    if (it != end()) return *it->second;
    return *s_emptyCSSValue;
  }
  ...
  inline bool HasProperty(wxCSS_PROPERTY propertyId) const {
...
public:
  inline wxCSS_VALUE GetAlignmentBaseline() const {
    ...
    return it != end() ? ((wxCSSPrimitiveValue&)*it->second).GetIdentValue()
                       : wxCSS_VALUE_AUTO;
  }
  inline bool HasAlignmentBaseline() const {
    return HasProperty(wxCSS_PROPERTY_ALIGNMENT_BASELINE);
  }
  inline void SetAlignmentBaseline(wxCSS_VALUE value) {
    ...
    if (it != end())
      ...
      (*this)[wxCSS_PROPERTY_ALIGNMENT_BASELINE] =
          new wxCSSPrimitiveValue(value);
  }
  ...
  inline bool HasBaselineShift() const {
    return HasProperty(wxCSS_PROPERTY_BASELINE_SHIFT);
  }
  ...
  inline bool HasClipPath() const {
    return HasProperty(wxCSS_PROPERTY_CLIP_PATH);
  }
  ...
  inline bool HasClipRule() const {
    return HasProperty(wxCSS_PROPERTY_CLIP_RULE);
  }
  ...
  inline wxRGBColor GetColor() const {
    ...
    return it != end() ? ((wxCSSPrimitiveValue&)*it->second).GetRGBColorValue()
                       : wxRGBColor();
  }
  ...
  inline bool HasColorInterpolation() const {
    return HasProperty(wxCSS_PROPERTY_COLOR_INTERPOLATION);
  }
  inline void SetColorInterpolation(wxCSS_VALUE value) {
    ...
    if (it != end())
      ...
      (*this)[wxCSS_PROPERTY_COLOR_INTERPOLATION] =
          new wxCSSPrimitiveValue(value);
  }
  ...
  inline bool HasColorInterpolationFilters() const {
    return HasProperty(wxCSS_PROPERTY_COLOR_INTERPOLATION_FILTERS);
  }
  inline void SetColorInterpolationFilters(wxCSS_VALUE value) {
    ...
    if (it != end())
      ...
      (*this)[wxCSS_PROPERTY_COLOR_INTERPOLATION_FILTERS] =
          new wxCSSPrimitiveValue(value);
  }
  ...
  inline bool HasColorProfile() const {
    return HasProperty(wxCSS_PROPERTY_COLOR_PROFILE);
  }
  ...
  inline bool HasColorRendering() const {
    return HasProperty(wxCSS_PROPERTY_COLOR_RENDERING);
  }
  ...
  inline bool HasDirection() const {
    return HasProperty(wxCSS_PROPERTY_DIRECTION);
  }
  ...
  inline bool HasDominantBaseline() const {
    return HasProperty(wxCSS_PROPERTY_DOMINANT_BASELINE);
  }
  inline void SetDominantBaseline(wxCSS_VALUE value) {
    ...
    if (it != end())
      ...
      (*this)[wxCSS_PROPERTY_DOMINANT_BASELINE] =
          new wxCSSPrimitiveValue(value);
  }
  ...
  inline bool HasEnableBackground() const {
    return HasProperty(wxCSS_PROPERTY_ENABLE_BACKGROUND);
  }
  inline void SetEnableBackground(wxCSS_VALUE value) {
    ...
    if (it != end())
      ...
      (*this)[wxCSS_PROPERTY_ENABLE_BACKGROUND] =
          new wxCSSPrimitiveValue(value);
  }
  ...
  inline double GetFillOpacity() const {
    ...
    return it != end() ? ((wxCSSPrimitiveValue&)*it->second).GetFloatValue()
                       : 1;
  }
  inline bool HasFillOpacity() const {
    return HasProperty(wxCSS_PROPERTY_FILL_OPACITY);
  }
  ...
  inline bool HasFillRule() const {
    return HasProperty(wxCSS_PROPERTY_FILL_RULE);
  }
  ...
  inline bool HasFloodColor() const {
    return HasProperty(wxCSS_PROPERTY_FLOOD_COLOR);
  }
  ...
  inline bool HasFloodOpacity() const {
    return HasProperty(wxCSS_PROPERTY_FLOOD_OPACITY);
  }
  ...
  inline wxString GetFontFamily() const {
    ...
    return it != end() ? ((wxCSSPrimitiveValue&)*it->second).GetStringValue()
                       : wxT("");
  }
  inline bool HasFontFamily() const {
    return HasProperty(wxCSS_PROPERTY_FONT_FAMILY);
  }
  ...
  inline bool HasFontSize() const {
    return HasProperty(wxCSS_PROPERTY_FONT_SIZE);
  }
  ...
  inline bool HasFontSizeAdjust() const {
    return HasProperty(wxCSS_PROPERTY_FONT_SIZE_ADJUST);
  }
  ...
  inline bool HasFontStretch() const {
    return HasProperty(wxCSS_PROPERTY_FONT_STRETCH);
  }
  ...
  inline bool HasFontStyle() const {
    return HasProperty(wxCSS_PROPERTY_FONT_STYLE);
  }
  ...
  inline bool HasFontVariant() const {
    return HasProperty(wxCSS_PROPERTY_FONT_VARIANT);
  }
  ...
  inline bool HasFontWeight() const {
    return HasProperty(wxCSS_PROPERTY_FONT_WEIGHT);
  }
  ...
  inline bool HasGlyphOrientationHorizontal() const {
    return HasProperty(wxCSS_PROPERTY_GLYPH_ORIENTATION_HORIZONTAL);
  }
  inline void SetGlyphOrientationHorizontal(double value) {
    ...
    if (it != end())
      ...
      (*this)[wxCSS_PROPERTY_GLYPH_ORIENTATION_HORIZONTAL] =
          new wxCSSPrimitiveValue(value);
  }
  ...
  inline bool HasGlyphOrientationVertical() const {
    return HasProperty(wxCSS_PROPERTY_GLYPH_ORIENTATION_VERTICAL);
  }
  inline void SetGlyphOrientationVertical(const wxCSSPrimitiveValue& value) {
    ...
    if (it != end()) {
      ...
      (*this)[wxCSS_PROPERTY_GLYPH_ORIENTATION_VERTICAL] =
          new wxCSSPrimitiveValue(value);
  }
  ...
  inline bool HasImageRendering() const {
    return HasProperty(wxCSS_PROPERTY_IMAGE_RENDERING);
  }
  ...
  inline bool HasLetterSpacing() const {
    return HasProperty(wxCSS_PROPERTY_LETTER_SPACING);
  }
  ...
  inline bool HasLightingColor() const {
    return HasProperty(wxCSS_PROPERTY_LIGHTING_COLOR);
  }
  ...
  inline bool HasMarkerEnd() const {
    return HasProperty(wxCSS_PROPERTY_MARKER_END);
  }
  ...
  inline bool HasMarkerMid() const {
    return HasProperty(wxCSS_PROPERTY_MARKER_MID);
  }
  ...
  inline bool HasMarkerStart() const {
    return HasProperty(wxCSS_PROPERTY_MARKER_START);
  }
  ...
  inline bool HasOverflow() const {
    return HasProperty(wxCSS_PROPERTY_OVERFLOW);
  }
  ...
  inline bool HasPointerEvents() const {
    return HasProperty(wxCSS_PROPERTY_POINTER_EVENTS);
  }
  ...
  inline bool HasShapeRendering() const {
    return HasProperty(wxCSS_PROPERTY_SHAPE_RENDERING);
  }
  ...
  inline bool HasStopColor() const {
    return HasProperty(wxCSS_PROPERTY_STOP_COLOR);
  }
  ...
  inline bool HasStopOpacity() const {
    return HasProperty(wxCSS_PROPERTY_STOP_OPACITY);
  }
  ...
  inline bool HasStrokeDasharray() const {
    return HasProperty(wxCSS_PROPERTY_STROKE_DASHARRAY);
  }
  ...
  inline bool HasStrokeDashoffset() const {
    return HasProperty(wxCSS_PROPERTY_STROKE_DASHOFFSET);
  }
  inline void SetStrokeDashoffset(double value) {
    ...
    if (it != end())
      ...
      (*this)[wxCSS_PROPERTY_STROKE_DASHOFFSET] =
          new wxCSSPrimitiveValue(value);
  }
  ...
  inline bool HasStrokeLinecap() const {
    return HasProperty(wxCSS_PROPERTY_STROKE_LINECAP);
  }
  ...
  inline bool HasStrokeLinejoin() const {
    return HasProperty(wxCSS_PROPERTY_STROKE_LINEJOIN);
  }
  ...
  inline bool HasStrokeMiterlimit() const {
    return HasProperty(wxCSS_PROPERTY_STROKE_MITERLIMIT);
  }
  inline void SetStrokeMiterlimit(double value) {
    ...
    if (it != end())
      ...
      (*this)[wxCSS_PROPERTY_STROKE_MITERLIMIT] =
          new wxCSSPrimitiveValue(value);
  }
  ...
  inline bool HasStrokeOpacity() const {
    return HasProperty(wxCSS_PROPERTY_STROKE_OPACITY);
  }
  ...
  inline bool HasStrokeWidth() const {
    return HasProperty(wxCSS_PROPERTY_STROKE_WIDTH);
  }
  ...
  inline bool HasTextAnchor() const {
    return HasProperty(wxCSS_PROPERTY_TEXT_ANCHOR);
  }
  ...
  inline bool HasTextDecoration() const {
    return HasProperty(wxCSS_PROPERTY_TEXT_DECORATION);
  }
  ...
  inline bool HasTextRendering() const {
    return HasProperty(wxCSS_PROPERTY_TEXT_RENDERING);
  }
  ...
  inline bool HasUnicodeBidi() const {
    return HasProperty(wxCSS_PROPERTY_UNICODE_BIDI);
  }
  ...
  inline bool HasVisibility() const {
    return HasProperty(wxCSS_PROPERTY_VISIBILITY);
  }
  ...
  inline bool HasWordSpacing() const {
    return HasProperty(wxCSS_PROPERTY_WORD_SPACING);
  }
  ...
  inline bool HasWritingMode() const {
    return HasProperty(wxCSS_PROPERTY_WRITING_MODE);
  }
