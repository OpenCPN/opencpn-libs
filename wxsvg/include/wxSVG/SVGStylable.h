...
public:
  ...
  inline const wxCSSStyleDeclaration& GetAnimStyle() const {
    return m_animStyle;
  }
...
public:
  inline void SetAlignmentBaseline(wxCSS_VALUE value) {
    m_style.SetAlignmentBaseline(value);
  }
  inline wxCSS_VALUE GetAlignmentBaseline() {
    return m_style.GetAlignmentBaseline();
  }
  ...
  inline void SetBaselineShift(const wxCSSPrimitiveValue& value) {
    m_style.SetBaselineShift(value);
  }
  inline const wxCSSPrimitiveValue& GetBaselineShift() {
    return m_style.GetBaselineShift();
  }
  inline bool HasBaselineShift() { return m_style.HasBaselineShift(); }

  inline void SetClip(const wxCSSPrimitiveValue& value) {
    m_style.SetClip(value);
  }
  ...
  inline void SetClipPath(const wxCSSPrimitiveValue& value) {
    m_style.SetClipPath(value);
  }
  inline const wxCSSPrimitiveValue& GetClipPath() {
    return m_style.GetClipPath();
  }
  ...
  inline void SetColorInterpolation(wxCSS_VALUE value) {
    m_style.SetColorInterpolation(value);
  }
  inline wxCSS_VALUE GetColorInterpolation() {
    return m_style.GetColorInterpolation();
  }
  inline bool HasColorInterpolation() {
    return m_style.HasColorInterpolation();
  }

  inline void SetColorInterpolationFilters(wxCSS_VALUE value) {
    m_style.SetColorInterpolationFilters(value);
  }
  inline wxCSS_VALUE GetColorInterpolationFilters() {
    return m_style.GetColorInterpolationFilters();
  }
  inline bool HasColorInterpolationFilters() {
    return m_style.HasColorInterpolationFilters();
  }

  inline void SetColorProfile(const wxCSSPrimitiveValue& value) {
    m_style.SetColorProfile(value);
  }
  inline const wxCSSPrimitiveValue& GetColorProfile() {
    return m_style.GetColorProfile();
  }
  inline bool HasColorProfile() { return m_style.HasColorProfile(); }

  inline void SetColorRendering(wxCSS_VALUE value) {
    m_style.SetColorRendering(value);
  }
  ...
  inline void SetDominantBaseline(wxCSS_VALUE value) {
    m_style.SetDominantBaseline(value);
  }
  inline wxCSS_VALUE GetDominantBaseline() {
    return m_style.GetDominantBaseline();
  }
  inline bool HasDominantBaseline() { return m_style.HasDominantBaseline(); }

  inline void SetEnableBackground(wxCSS_VALUE value) {
    m_style.SetEnableBackground(value);
  }
  inline wxCSS_VALUE GetEnableBackground() {
    return m_style.GetEnableBackground();
  }
  ...
  inline void SetFontSizeAdjust(const wxCSSPrimitiveValue& value) {
    m_style.SetFontSizeAdjust(value);
  }
  inline const wxCSSPrimitiveValue& GetFontSizeAdjust() {
    return m_style.GetFontSizeAdjust();
  }
  inline bool HasFontSizeAdjust() { return m_style.HasFontSizeAdjust(); }

  inline void SetFontStretch(wxCSS_VALUE value) {
    m_style.SetFontStretch(value);
  }
  ...
  inline void SetGlyphOrientationHorizontal(double value) {
    m_style.SetGlyphOrientationHorizontal(value);
  }
  inline double GetGlyphOrientationHorizontal() {
    return m_style.GetGlyphOrientationHorizontal();
  }
  inline bool HasGlyphOrientationHorizontal() {
    return m_style.HasGlyphOrientationHorizontal();
  }

  inline void SetGlyphOrientationVertical(const wxCSSPrimitiveValue& value) {
    m_style.SetGlyphOrientationVertical(value);
  }
  inline const wxCSSPrimitiveValue& GetGlyphOrientationVertical() {
    return m_style.GetGlyphOrientationVertical();
  }
  inline bool HasGlyphOrientationVertical() {
    return m_style.HasGlyphOrientationVertical();
  }

  inline void SetImageRendering(wxCSS_VALUE value) {
    m_style.SetImageRendering(value);
  }
  ...
  inline void SetPointerEvents(wxCSS_VALUE value) {
    m_style.SetPointerEvents(value);
  }
  ...
  inline void SetShapeRendering(wxCSS_VALUE value) {
    m_style.SetShapeRendering(value);
  }
  ...
  inline void SetStrokeDasharray(const wxCSSValueList& value) {
    m_style.SetStrokeDasharray(value);
  }
  inline const wxCSSValueList& GetStrokeDasharray() {
    return m_style.GetStrokeDasharray();
  }
  inline bool HasStrokeDasharray() { return m_style.HasStrokeDasharray(); }

  inline void SetStrokeDashoffset(double value) {
    m_style.SetStrokeDashoffset(value);
  }
  ...
  inline void SetStrokeLinecap(wxCSS_VALUE value) {
    m_style.SetStrokeLinecap(value);
  }
  ...
  inline void SetStrokeLinejoin(wxCSS_VALUE value) {
    m_style.SetStrokeLinejoin(value);
  }
  ...
  inline void SetStrokeMiterlimit(double value) {
    m_style.SetStrokeMiterlimit(value);
  }
  ...
  inline void SetStrokeOpacity(double value) {
    m_style.SetStrokeOpacity(value);
  }
  ...
  inline void SetTextDecoration(wxCSS_VALUE value) {
    m_style.SetTextDecoration(value);
  }
  ...
  inline void SetTextRendering(wxCSS_VALUE value) {
    m_style.SetTextRendering(value);
  }
  ...
  inline void SetWordSpacing(const wxCSSPrimitiveValue& value) {
    m_style.SetWordSpacing(value);
  }
  inline const wxCSSPrimitiveValue& GetWordSpacing() {
    return m_style.GetWordSpacing();
  }
  inline bool HasWordSpacing() { return m_style.HasWordSpacing(); }

  inline void SetWritingMode(wxCSS_VALUE value) {
    m_style.SetWritingMode(value);
  }
...
public:
  ...
  static const wxCSSStyleDeclaration& GetElementStyle(
