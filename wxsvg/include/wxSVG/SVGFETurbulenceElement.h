...
class wxSVGFETurbulenceElement : public wxSVGElement,
...
public:
  inline const wxSVGAnimatedNumber& GetBaseFrequencyX() const {
    return m_baseFrequencyX;
  }
  inline void SetBaseFrequencyX(const wxSVGAnimatedNumber& n) {
    m_baseFrequencyX = n;
  }
  inline void SetBaseFrequencyX(float n) { m_baseFrequencyX.SetBaseVal(n); }

  inline const wxSVGAnimatedNumber& GetBaseFrequencyY() const {
    return m_baseFrequencyY;
  }
  inline void SetBaseFrequencyY(const wxSVGAnimatedNumber& n) {
    m_baseFrequencyY = n;
  }
  inline void SetBaseFrequencyY(float n) { m_baseFrequencyY.SetBaseVal(n); }

  inline const wxSVGAnimatedInteger& GetNumOctaves() const {
    return m_numOctaves;
  }
  ...
  inline const wxSVGAnimatedEnumeration& GetStitchTiles() const {
    return m_stitchTiles;
  }
  inline void SetStitchTiles(const wxSVGAnimatedEnumeration& n) {
    m_stitchTiles = n;
  }
...
public:
  ...
  wxSvgXmlNode* CloneNode(bool deep = true) {
    return new wxSVGFETurbulenceElement(*this);
  }
