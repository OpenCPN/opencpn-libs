...
public:
  ...
  wxSVGAnimatedAngle(const wxSVGAngle& value)
      : m_baseVal(value), m_animVal(NULL) {}
  wxSVGAnimatedAngle(const wxSVGAnimatedAngle& value)
  ...
  inline wxSVGAnimatedAngle& operator=(const wxSVGAnimatedAngle& value) {
    ...
    m_animVal =
        value.m_animVal != NULL ? new wxSVGAngle(*value.m_animVal) : NULL;
    return *this;
  }

  inline wxSVGAngle& GetBaseVal() { return m_baseVal; }
  inline const wxSVGAngle& GetBaseVal() const { return m_baseVal; }
  inline void SetBaseVal(const wxSVGAngle& value) {
    m_baseVal = value;
    ResetAnimVal();
  }

  inline wxSVGAngle& GetAnimVal() {
    if (!m_animVal) m_animVal = new wxSVGAngle(m_baseVal);
    return *m_animVal;
  }
