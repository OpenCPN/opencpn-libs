...
public:
  ...
  wxSVGAnimatedTransformList(const wxSVGTransformList& value)
      : m_baseVal(value), m_animVal(NULL) {}
  wxSVGAnimatedTransformList(const wxSVGAnimatedTransformList& value)
      : m_baseVal(value.m_baseVal), m_animVal(NULL) {
    if (value.m_animVal != NULL)
      m_animVal = new wxSVGTransformList(*value.m_animVal);
  }
  ~wxSVGAnimatedTransformList() { ResetAnimVal(); }

  inline wxSVGAnimatedTransformList& operator=(
      const wxSVGAnimatedTransformList& value) {
    m_baseVal = value.m_baseVal;
    m_animVal = value.m_animVal != NULL
                    ? new wxSVGTransformList(*value.m_animVal)
                    : NULL;
    return *this;
  }
  ...
  inline void SetBaseVal(const wxSVGTransformList& value) {
    m_baseVal = value;
    ResetAnimVal();
  }

  inline wxSVGTransformList& GetAnimVal() {
    if (!m_animVal) m_animVal = new wxSVGTransformList(m_baseVal);
    return *m_animVal;
  }
