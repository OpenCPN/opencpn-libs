...
public:
  ...
  inline const wxSVGAnimatedNumber& GetDiffuseConstant() const {
    return m_diffuseConstant;
  }
  inline void SetDiffuseConstant(const wxSVGAnimatedNumber& n) {
    m_diffuseConstant = n;
  }
...
public:
  ...
  wxSvgXmlNode* CloneNode(bool deep = true) {
    return new wxSVGFEDiffuseLightingElement(*this);
  }
