...
class wxSVGColorProfileElement : public wxSVGElement,
...
public:
  ...
  inline wxRENDERING_INTENT GetRenderingIntent() const {
    return m_renderingIntent;
  }
  inline void SetRenderingIntent(const wxRENDERING_INTENT& n) {
    m_renderingIntent = n;
  }
...
public:
  ...
  wxSvgXmlNode* CloneNode(bool deep = true) {
    return new wxSVGColorProfileElement(*this);
  }
