...
public:
  ...
  inline void SetCSSValueType(wxCSS_VALUE_TYPE cssValueType) {
    m_cssValueType = cssValueType;
  }
...
public:
  wxCSSPrimitiveValue()
      : wxCSSValue(wxCSS_PRIMITIVE_VALUE), m_primitiveType(wxCSS_UNKNOWN) {}
  wxCSSPrimitiveValue(double value)
      : wxCSSValue(wxCSS_PRIMITIVE_VALUE),
        m_primitiveType(wxCSS_NUMBER),
        m_number(value) {}
  wxCSSPrimitiveValue(const wxString& value)
      : wxCSSValue(wxCSS_PRIMITIVE_VALUE),
        m_primitiveType(wxCSS_STRING),
        m_string(new wxString(value)) {}
  wxCSSPrimitiveValue(const wxRect& value)
      : wxCSSValue(wxCSS_PRIMITIVE_VALUE),
        m_primitiveType(wxCSS_RECT),
        m_rect(new wxRect(value)) {}
  wxCSSPrimitiveValue(const wxRGBColor& value)
      : wxCSSValue(wxCSS_PRIMITIVE_VALUE),
        m_primitiveType(wxCSS_RGBCOLOR),
        m_color(new wxRGBColor(value)) {}
  wxCSSPrimitiveValue(wxCSS_VALUE value)
      : wxCSSValue(wxCSS_PRIMITIVE_VALUE),
  ...
  inline wxCSS_PRIMITIVE_TYPE GetCSSPrimitiveType() const {
    return m_primitiveType;
  }
  inline void SetCSSPrimitiveType(wxCSS_PRIMITIVE_TYPE primitiveType) {
    m_primitiveType = primitiveType;
  }

  virtual wxString GetCSSText() const;

  void SetStringValue(wxCSS_PRIMITIVE_TYPE stringType,
...
public:
  ...
  wxCSSPrimitiveValue Item(int index) const {
    return wxCSSPrimitiveValue(m_values[index]);
  }
};
