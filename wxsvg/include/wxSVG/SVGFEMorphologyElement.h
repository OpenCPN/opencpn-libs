...
class wxSVGFEMorphologyElement : public wxSVGElement,
...
public:
  ...
  inline const wxSVGAnimatedEnumeration& GetOperator() const {
    return m_operator;
  }
  ...
  inline const wxSVGAnimatedLength& GetRadiusX() const {
    WX_SVG_ANIM_LENGTH_CALC_WIDTH(m_radiusX, GetViewportElement());
    return m_radiusX;
  }
  ...
  inline const wxSVGAnimatedLength& GetRadiusY() const {
    WX_SVG_ANIM_LENGTH_CALC_HEIGHT(m_radiusY, GetViewportElement());
    return m_radiusY;
  }
...
public:
  ...
  wxSvgXmlNode* CloneNode(bool deep = true) {
    return new wxSVGFEMorphologyElement(*this);
  }
