...
class wxSVGTextPathElement : public wxSVGTextContentElement,
...
public:
  inline const wxSVGAnimatedLength& GetStartOffset() const {
    WX_SVG_ANIM_LENGTH_CALC_WIDTH(m_startOffset, GetViewportElement());
    return m_startOffset;
  }
  inline void SetStartOffset(const wxSVGAnimatedLength& n) {
    m_startOffset = n;
  }
  inline void SetStartOffset(const wxSVGLength& n) {
    m_startOffset.SetBaseVal(n);
  }
  ...
  inline const wxSVGAnimatedEnumeration& GetSpacing() const {
    return m_spacing;
  }
...
public:
  ...
  wxSvgXmlNode* CloneNode(bool deep = true) {
    return new wxSVGTextPathElement(*this);
  }
