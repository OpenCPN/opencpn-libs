...
class wxSVGFESpotLightElement : public wxSVGElement {
protected:
...
public:
  ...
  inline const wxSVGAnimatedNumber& GetLimitingConeAngle() const {
    return m_limitingConeAngle;
  }
  inline void SetLimitingConeAngle(const wxSVGAnimatedNumber& n) {
    m_limitingConeAngle = n;
  }
  inline void SetLimitingConeAngle(float n) {
    m_limitingConeAngle.SetBaseVal(n);
  }
...
public:
  ...
  wxSvgXmlNode* CloneNode(bool deep = true) {
    return new wxSVGFESpotLightElement(*this);
  }
