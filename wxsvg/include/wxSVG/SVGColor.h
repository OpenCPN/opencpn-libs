...
class wxSVGColor : public wxCSSValue {
protected:
...
public:
  wxSVGColor()
      : wxCSSValue(wxCSS_SVG_COLOR), m_colorType(wxSVG_COLORTYPE_UNKNOWN) {}
  wxSVGColor(wxRGBColor color)
  ...
  virtual void SetRGBColorICCColor(const wxString& rgbColor,
                                   const wxString& iccColor);
  virtual void SetColor(wxSVG_COLORTYPE colorType, const wxString& rgbColor,
                        const wxString& iccColor);
};
