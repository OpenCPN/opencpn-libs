...
enum {
  ...
  wxCCSP_DEFAULT_STYLE =
      wxCCSP_PROXY_OPTIONS | wxCCSP_AUTHENTICATION_OPTIONS | wxCCSP_PORT_OPTION
};
...
public:
  ...
  wxCurlConnectionSettingsPanel(
      ...
      const wxSize& size = wxDefaultSize, long style = wxCCSP_DEFAULT_STYLE,
