...
#define SKM_DEFINE_STACK_OF(t1, t2, t3)                                        \
  ...
  static ossl_unused ossl_inline t2 *sk_##t1##_value(const STACK_OF(t1) * sk,  \
                                                     int idx) {                \
  ...
  static ossl_unused ossl_inline t2 *sk_##t1##_set(STACK_OF(t1) * sk, int idx, \
                                                   t2 *ptr) {                  \
  ...
  static ossl_unused ossl_inline int sk_##t1##_is_sorted(const STACK_OF(t1) *  \
                                                         sk) {                 \
